...
function getAddonPath(osInfo) {
    const winPath = wps.Env.GetAppDataPath() + `/kingsoft/wps/jsaddons/Zotero-Jsa_1.0.0`;


    const linuxPath = wps.Env.GetHomePath() + `/.local/share/Kingsoft/wps/jsaddons/Zotero-Jsa_1.0.0`;

    const macPath = wps.Env.GetHomePath() + `/.kingsoft/wps/jsaddons/Zotero-Jsa_1.0.0`;
    if (osInfo == "windows") {
